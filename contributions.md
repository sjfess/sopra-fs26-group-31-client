...
| ****[@sjfess](https://github.com/sjfess)**** | 03.04.26   | [Commit 13b3144](13b31443e6a6fd7a2f3af0d572c5b3c2effa367d) | Implemented the Game Lobby UI and Game Lobby logic| A user needs to be able to create a game and join a game and further the host of the game lobby needs to be able to adjust the settings of the game lobby itself. |
