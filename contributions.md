...
|                    | 26.3.26  | [Commit c4ef6c2](https://github.com/sjfess/sopra-fs26-group-31-server/commit/c4ef6c250ba69431fe3c125a5a92d473bbb52417) | Implemented timeline structure, placement ruling and the placement API-part from development task [#27](https://github.com/sjfess/sopra-fs26-group-31-server/issues/27) | The contribution is relevant since the timeline structure, placement rules and placement API are required to implement the frontend-UI and timeline-updates |
